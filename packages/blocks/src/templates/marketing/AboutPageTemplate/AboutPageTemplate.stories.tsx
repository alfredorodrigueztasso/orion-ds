...
const COMPANY_TIMELINE = [
  {
    ...
    title: "Founded",
    description:
      "Started in a small apartment with a big dream to revolutionize development.",
  ...
  },
  {
    ...
    description:
      "Launched our first product to overwhelming positive response.",
    status: "completed" as const,
  },
  {
    id: "4",
...
const STORY_CAROUSEL_ITEMS = [
  {
    ...
    description:
      "Like many great tech companies, we started small but dreamed big.",
...
export const TeamFocused: Story = {
  args: {
    ...
    hero: {
      ...
      description:
        "The talented people building Acme and shaping the future of development.",
      align: "center",
      size: "sm",
    },
    team: {
...
export const Minimal: Story = {
  args: {
    hero: {
      headline: "About Acme",
      description:
        "We're building tools that empower developers to ship faster.",
      align: "center",
      size: "md",
    },
    stats: {
