    ...
    <Card>
      ...
      <Card.Body>
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          ...
          <Button icon={<Trash2 size={20} />} variant="danger" aria-label="Delete" iconOnly />
        </div>
      </Card.Body>
    </Card>
  );
  ...
  return (
    <Card>
      ...
      <Card.Body style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <Field type="email" placeholder="Enter your email" icon={<Mail size={18} />} />

        <Field type="text" placeholder="Search for something..." icon={<Search size={18} />} />
      </Card.Body>
    </Card>
  );
}
  ...
  return (
    <ThemeProvider>
      ...
      >
        ...
        <p>
          This example demonstrates how to use Lucide icons with various Orion React components.
        </p>
        ...
        >
          ...
          <ul>
            ...
            <li>
              <strong>Documentation</strong>: See <code>LUCIDE_ICONS.md</code> in the React package
            </li>
            <li>
              <strong>Import</strong>: <code>import {{ IconName }} from 'lucide-react';</code>
            </li>
            <li>
              <strong>Size</strong>: Use <code>size</code> prop in pixels (16, 20, 24, 32)
            </li>
          </ul>
        </div>
      </div>
