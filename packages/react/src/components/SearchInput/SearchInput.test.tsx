...
describe('SearchInput', () => {
  ...
  it('calls onSearch when Enter is pressed', () => {
    ...
    render(<SearchInput value="test query" onChange={() => {}} onSearch={onSearch} />);
  ...
  it('calls onSearch when search button is clicked', () => {
    const onSearch = vi.fn();
    render(<SearchInput value="test" onChange={() => {}} onSearch={onSearch} showSearchButton />);
  ...
  it('accepts custom clear label', () => {
    render(<SearchInput value="test" onChange={() => {}} clearLabel="Limpiar" />);
