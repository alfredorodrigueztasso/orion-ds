...
describe('Radio', () => {
  ...
  it('renders with helper text', () => {
    render(<Radio label="Pro Plan" helperText="Recommended for teams" name="plan" value="pro" />);
  ...
  it('applies error class when error prop is provided', () => {
    const { container } = render(<Radio label="Plan" error="Required" name="plan" value="plan" />);
