...
describe('Dropdown', () => {
  ...
  it('calls onSelect callback when item is selected', async () => {
    ...
    render(<Dropdown trigger={<button>Open Menu</button>} items={mockItems} onSelect={onSelect} />);
  ...
  it('stays open on item selection when closeOnSelect is false', async () => {
    ...
    render(
      <Dropdown trigger={<button>Open Menu</button>} items={mockItems} closeOnSelect={false} />,
    );
  ...
  it('does not trigger disabled items', async () => {
    ...
    render(
      <Dropdown
        trigger={<button>Open Menu</button>}
        items={[{ id: 'disabled', label: 'Disabled Item', disabled: true, onClick }]}
      />,
    );
  ...
  it('renders items with icons', async () => {
    ...
    render(
      <Dropdown
        trigger={<button>Open Menu</button>}
        items={[{ id: 'edit', label: 'Edit', icon: <span data-testid="edit-icon">✏️</span> }]}
      />,
    );
  ...
  it('renders items with shortcuts', async () => {
    ...
    render(
      <Dropdown
        trigger={<button>Open Menu</button>}
        items={[{ id: 'edit', label: 'Edit', shortcut: '⌘E' }]}
      />,
    );
