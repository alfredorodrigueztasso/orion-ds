...
describe('ProgressBar', () => {
  ...
  it('applies variant classes correctly', () => {
    const { container, rerender } = render(<ProgressBar value={50} variant="primary" />);
  ...
  it('renders indeterminate state', () => {
    ...
    expect((container.firstChild as HTMLElement).className).toMatch(/indeterminate/);
  });
  ...
  it('uses custom label in aria-label', () => {
    ...
    expect(screen.getByRole('progressbar')).toHaveAttribute('aria-label', 'Downloading file');
  });
