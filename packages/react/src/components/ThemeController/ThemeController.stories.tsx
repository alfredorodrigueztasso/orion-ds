...
export const InNavbar: Story = {
  render: () => (
    <div>
      ...
      >
        <div style={{ fontSize: 'var(--font-size-20)', fontWeight: 'var(--font-weight-bold)' }}>
          MyApp
        </div>
...
export const FloatingControl: Story = {
  render: () => (
    ...
    >
      ...
      <p style={{ color: 'var(--text-secondary)' }}>
        This is useful for demo pages or documentation sites where you want users to quickly change
        themes without navigating away.
      </p>
