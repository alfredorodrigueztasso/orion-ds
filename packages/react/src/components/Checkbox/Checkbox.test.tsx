...
describe('Checkbox', () => {
  ...
  it('hides helper text when error is shown', () => {
    render(<Checkbox label="Subscribe" helperText="Weekly updates" error="Required field" />);
  ...
  it('passes through input attributes', () => {
    render(<Checkbox label="Test" data-testid="test-checkbox" name="terms" value="accepted" />);
  ...
  it('links error message with checkbox via aria-describedby', () => {
    ...
    const checkbox = screen.getByRole('checkbox');
    expect(checkbox).toHaveAttribute('aria-describedby', 'terms-checkbox-error');
    expect(screen.getByRole('alert')).toHaveAttribute('id', 'terms-checkbox-error');
  });

  it('links helper text with checkbox via aria-describedby', () => {
    render(<Checkbox label="Subscribe" helperText="Weekly" id="subscribe-checkbox" />);
    const checkbox = screen.getByRole('checkbox');
    expect(checkbox).toHaveAttribute('aria-describedby', 'subscribe-checkbox-helper');
    expect(screen.getByText('Weekly')).toHaveAttribute('id', 'subscribe-checkbox-helper');
  });
  ...
  it('supports controlled component pattern', async () => {
    ...
    const { rerender } = render(<Checkbox label="Controlled" checked={false} readOnly />);
    expect(screen.getByRole('checkbox')).not.toBeChecked();
