...
describe('Field', () => {
  ...
  it('hides helper text when error is shown', () => {
    render(
      <Field label="Password" helperText="Must be 8+ characters" error="Password too short" />,
    );
  ...
  it('does not show error icon when right icon is provided', () => {
    render(
      <Field label="Email" error="Invalid" rightIcon={<span data-testid="custom-icon">✓</span>} />,
    );
