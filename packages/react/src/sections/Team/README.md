...
```tsx
<Team variant="default" members={members} columns={4} />
```
...
```tsx
<Team variant="cards" members={members} columns={3} />
```
...
```tsx
<Team variant="compact" members={members} columns={4} />
```
...
```tsx
<Team title="Engineering Team" members={engineers} columns={3} />
```
...
```tsx
<Team title="Our Team" members={allMembers} columns={4} />
```
