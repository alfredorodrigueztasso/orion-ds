...
const AppleStoreBadge: React.FC = () => (
  <svg width="135" height="40" viewBox="0 0 135 40">
    ...
    <text x="67.5" y="12" fill="#fff" fontSize="8" textAnchor="middle" fontFamily="system-ui">
      Download on the
    </text>
    <text
      x="67.5"
...
const StoreBadge: React.FC<{ badge: AppStoreBadge }> = ({ badge }) => {
  ...
  return (
    <a href={badge.href} className={styles.badge} target="_blank" rel="noopener noreferrer">
      {renderBadgeContent()}
    </a>
  );
};
