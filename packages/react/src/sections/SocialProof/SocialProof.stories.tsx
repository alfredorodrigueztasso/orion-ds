...
const meta = {
  ...
  argTypes: {
    layout: {
      control: 'select',
      options: ['stacked', 'side-by-side', 'testimonials-only', 'logos-only', 'stats-only'],
    },
    logoStyle: {
      control: 'select',
...
const defaultLogos = [
  ...
  { name: 'TechCorp', logo: 'https://via.placeholder.com/120x40?text=TechCorp' },
  { name: 'StartupXYZ', logo: 'https://via.placeholder.com/120x40?text=StartupXYZ' },
  { name: 'DesignCo', logo: 'https://via.placeholder.com/120x40?text=DesignCo' },
  { name: 'CloudBase', logo: 'https://via.placeholder.com/120x40?text=CloudBase' },
];
