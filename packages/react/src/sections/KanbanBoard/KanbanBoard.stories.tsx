    ...
    cards: [
      {
        ...
        assignees: [{ id: 'user-1', name: 'John Doe', avatar: 'https://i.pravatar.cc/150?img=1' }],
        dueDate: '2024-02-15',
        priority: 'high',
      },
      {
        ...
        assignees: [
          ...
          { id: 'user-3', name: 'Bob Wilson', avatar: 'https://i.pravatar.cc/150?img=3' },
        ],
        priority: 'urgent',
      },
    ],
...
export const Interactive: Story = {
  render: () => {
    ...
    return (
      <KanbanBoard columns={columns} onCardClick={handleCardClick} onAddCard={handleAddCard} />
    );
  },
};
