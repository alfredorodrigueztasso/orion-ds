...
<Hero
  ...
  headline={
    <>
      Build <Hero.Highlight>Beautiful</Hero.Highlight> Products
    </>
  }
...
<Hero
  ...
  headline={
    <>
      Build <Hero.Highlight>Faster</Hero.Highlight>
    </>
  }
...
<Hero
  headline={
    <>
      Design systems that <Hero.Highlight>actually work</Hero.Highlight>
    </>
  }
/>
```
...
<>
  ...
  <Hero
    ...
    headline={
      <>
        Analytics That <Hero.Highlight>Actually Make Sense</Hero.Highlight>
      </>
    }
...
<Hero
  ...
  headline={
    <>
      Your Productivity, <Hero.Highlight>Supercharged</Hero.Highlight>
    </>
  }
