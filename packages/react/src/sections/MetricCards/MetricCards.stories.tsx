...
import { DollarSign, Users, ShoppingCart, TrendingUp, Activity, Eye } from 'lucide-react';
...
export const Compact: Story = {
  args: {
    variant: 'compact',
    metrics: [
      { label: 'Revenue', value: '$12.5K', change: { value: '+12%', positive: true } },
      { label: 'Orders', value: '156', change: { value: '+8%', positive: true } },
      { label: 'Customers', value: '89', change: { value: '-3%', positive: false } },
      { label: 'Conversion', value: '3.2%', change: { value: '+0.5%', positive: true } },
    ],
    columns: 4,
  },
};
...
export const FiveColumns: Story = {
  args: {
    metrics: [
      { label: 'Views', value: '45.2K', change: { value: '+12%', positive: true } },
      { label: 'Clicks', value: '2.1K', change: { value: '+8%', positive: true } },
      { label: 'CTR', value: '4.6%', change: { value: '+0.3%', positive: true } },
      { label: 'Conversions', value: '384', change: { value: '-2%', positive: false } },
      { label: 'Revenue', value: '$9.8K', change: { value: '+15%', positive: true } },
    ],
    columns: 5,
  },
};
...
export const NoIcons: Story = {
  args: {
    metrics: [
      { label: 'Total Sales', value: '$892,123', change: { value: '+18.2%', positive: true } },
      { label: 'Avg. Order Value', value: '$156.32', change: { value: '+5.1%', positive: true } },
      { label: 'Refund Rate', value: '1.8%', change: { value: '-0.3%', positive: true } },
    ],
    columns: 3,
  },
};
