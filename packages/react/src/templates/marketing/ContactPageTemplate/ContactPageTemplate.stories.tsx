...
import { Twitter, Github, Linkedin, Mail, Phone, MapPin, Clock, MessageSquare } from 'lucide-react';
...
const meta: Meta<typeof ContactPageTemplate> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A complete contact page template with contact form, office locations, and FAQ.',
      },
    },
  },
  tags: ['autodocs'],
...
const CONTACT_FAQ = [
  ...
  },
  {
    ...
    answer:
      'Phone support is available for Pro and Enterprise customers. Starter plan customers can reach us via email or our community forum.',
  },
  {
    question: 'Where are your offices located?',
    answer:
      'Our headquarters is in San Francisco, with additional offices in London, Singapore, and Sydney.',
  },
  {
    question: 'How do I report a bug?',
    answer:
      'You can report bugs through our GitHub repository or by emailing support@acme.com with details and steps to reproduce.',
  },
];
...
export const WithLocations: Story = {
  args: {
    ...
    hero: {
      badge: (
        <Badge variant="brand">
          <MapPin size={14} style={{ marginRight: 4 }} /> Our Offices
        </Badge>
      ),
      headline: 'Visit us',
...
export const SalesContact: Story = {
  args: {
    ...
    hero: {
      ...
      description:
        'Ready to get started? Our sales team is here to help you find the right solution.',
      ...
      items: [
        {
          ...
          answer:
            'Enterprise includes unlimited users, SSO/SAML, audit logs, dedicated support, custom SLA, and on-premise deployment options.',
        },
        {
          question: 'Can I get a custom contract?',
          answer:
            'Yes, we offer custom contracts for Enterprise customers with specific requirements.',
        },
        {
          question: 'Do you offer POC/pilot programs?',
          answer:
            'Yes, we offer pilot programs to help you evaluate the product before committing.',
        },
      ],
    },
...
export const SupportContact: Story = {
  args: {
    ...
    hero: {
      badge: (
        <Badge variant="info">
          <MessageSquare size={14} style={{ marginRight: 4 }} /> Support
        </Badge>
      ),
