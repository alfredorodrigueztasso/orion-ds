...
const PRICING_FAQ = [
  ...
  },
  {
    ...
    answer:
      "We accept all major credit cards (Visa, Mastercard, American Express) and PayPal. Enterprise customers can also pay via invoice and wire transfer.",
  },
  {
    question: "Is there a free trial?",
    answer:
      "Yes! Pro plan includes a 14-day free trial with full access to all features. No credit card required to start.",
  },
  {
    question: "What happens when I exceed my storage limit?",
    answer:
      "We'll notify you when you're approaching your limit. You can either upgrade your plan or purchase additional storage. We'll never delete your data without notice.",
  },
  {
    question: "Do you offer discounts for annual billing?",
    answer:
      "Yes, annual billing saves you 20% compared to monthly billing. The discount is applied automatically when you select annual billing.",
  },
  {
...
export const Enterprise: Story = {
  args: {
    ...
    hero: {
      ...
      description:
        "Secure, reliable, and enterprise-ready. Trusted by Fortune 500 companies.",
    ...
    comparison: {
      ...
      columns: COMPARISON_COLUMNS,
      features: COMPARISON_FEATURES.filter(
        (f) => f.category === "Security" || f.category === "Support",
      ),
    },
    faq: {
      ...
      items: [
        {
          ...
          answer:
            "We are SOC2 Type II certified, GDPR compliant, and ISO 27001 certified. We also support HIPAA compliance for healthcare customers.",
        },
        {
          question: "Do you offer on-premise deployment?",
          answer:
            "Yes, Enterprise plans include the option for on-premise or hybrid deployment. Our team will work with you to design the right architecture.",
        },
        {
          question: "What SLA do you offer?",
          answer:
            "Enterprise plans include a 99.99% uptime SLA with financial credits for any downtime.",
        },
      ],
    },
    cta: {
