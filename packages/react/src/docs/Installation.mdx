...
<Steps>
  <Step number={1} title="Initialize your project">
    Run <code>npx @orion-ds/cli init</code> — creates an <code>orion.json</code> config file.
  </Step>
...
After init, import the CSS once:
...
<Callout variant="info" title="TypeScript errors?">
  Make sure <code>@orion-ds/react</code> is installed and imported correctly.
</Callout>
