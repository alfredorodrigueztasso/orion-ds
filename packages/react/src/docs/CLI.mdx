...
<Steps>
  <Step number={1} title="Configure your project">
    Run <code>npx @orion-ds/cli init</code> to create an <code>orion.json</code> config file.
  </Step>
...
Creates an `orion.json` config file in your project root.
...
After init, import the CSS once in your entry file:
