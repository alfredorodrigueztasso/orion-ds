...
const WithMultipleActionsPreview = () => {
  const items = [
...
export const previews = [
  {
    ...
    render: BasicDropdownPreview,
  },
  {
    title: 'With Text Button',
    render: WithTextButtonPreview,
  },
  {
    title: 'With Multiple Actions',
    render: WithMultipleActionsPreview,
  },
];
