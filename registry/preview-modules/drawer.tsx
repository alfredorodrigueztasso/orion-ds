...
const NotificationsDrawerPreview = () => {
  const [open, setOpen] = useState(false);
...
export const previews = [
  {
    ...
    render: NavigationDrawerPreview,
  },
  {
    title: 'Settings Drawer (Right)',
    render: SettingsDrawerPreview,
  },
  {
    title: 'Notifications Drawer',
    render: NotificationsDrawerPreview,
  },
];
