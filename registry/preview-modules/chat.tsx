...
const BasicChatInterfacePreview = () => {
...
const WithTypingIndicatorPreview = () => {
...
const CodeMarkdownSupportPreview = () => {
  const [messages] = useState([
    {
      id: '1',
      role: 'user' as const,
...
export const previews = [
  {
    ...
    render: BasicChatInterfacePreview,
  },
  {
    title: 'With Typing Indicator',
    render: WithTypingIndicatorPreview,
  },
  {
    title: 'Code & Markdown Support',
    render: CodeMarkdownSupportPreview,
  },
];
