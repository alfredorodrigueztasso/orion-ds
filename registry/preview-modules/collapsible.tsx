...
const MultipleCollapsiblesPreview = () => (
  <div style={{ display: 'grid', gap: 'var(--spacing-3)', maxWidth: '400px' }}>
...
export const previews = [
  {
    ...
    render: BasicCollapsiblePreview,
  },
  {
    title: 'Controlled State',
    render: ControlledStatePreview,
  },
  {
    title: 'Multiple Collapsibles',
    render: MultipleCollapsiblesPreview,
  },
];
