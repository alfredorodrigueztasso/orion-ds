...
const ProgrammingLanguagesPreview = () => {
  const [value, setValue] = useState<string | null>(null);
...
export const previews = [
  {
    ...
    render: CountrySelectionPreview,
  },
  {
    title: 'Programming Languages',
    render: ProgrammingLanguagesPreview,
  },
  {
    title: 'With Descriptions',
    render: WithDescriptionsPreview,
  },
];
