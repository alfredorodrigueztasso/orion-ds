import {
  require_jsx_runtime
} from "./chunk-V5GXOSVK.js";
import {
  require_react_dom
} from "./chunk-3NWUM43V.js";
import {
  Wu,
  Ya,
  br,
...
// ../../node_modules/.pnpm/@storybook+core@8.6.15_storybook@8.6.15/node_modules/@storybook/core/dist/components/index.js
...
var r2 = S(() => {
  ...
  _b = [
    ...
    let r = t2.forwardRef((n, o) => {
      ...
      return typeof window < "u" && (window[/* @__PURE__ */ Symbol.for("radix-ui")] = true), (0, import_jsx_runtime2.jsx)(s, { ...l, ref: o });
    });
...
function l2(e, t = []) {
  ...
  function n(i, l) {
    ...
    r = [...r, l];
    function p(h5) {
      let { scope: f, children: g, ...w } = h5, m = f?.[e][c] || s, v = Ht.useMemo(() => w, Object.values(w));
...
function ar(e, t, { checkForDefaultPrevented: r = true } = {}) {
  return a(function(o) {
    if (e?.(o), r === false || !o.defaultPrevented)
      return t?.(o);
  }, "handleEvent");
}
var h2 = S(() => {
...
function Sc(e, t, r) {
  ...
  let o = n.children.map(() => /* @__PURE__ */ Symbol(""));
  return e.map((i, l) => {
    let s = i.node;
    if (rt(s)) {
      if (s.prev && rt(s.prev)) {
...
function qR(e, t, r) {
  ...
  let o = n.children.length === 1 && (n.firstChild.type === "interpolation" || n.firstChild.type === "angularIcuExpression") && n.firstChild.isLeadingSpaceSensitive && !n.firstChild.hasLeadingSpaces && n.lastChild.isTrailingSpaceSensitive && !n.lastChild.hasTrailingSpaces, i = /* @__PURE__ */ Symbol(
...
function Ok(e, t) {
  let { originalText: r, [/* @__PURE__ */ Symbol.for("comments")]: n, locStart: o, locEnd: i, [/* @__PURE__ */ Symbol.for("printedComments")]: l } = t, { node: s } = e, c = o(
    s
  ), p = i(s);
...
async function Ig(e, t) {
  let r = e.comments ?? [];
  t[/* @__PURE__ */ Symbol.for("comments")] = r, t[/* @__PURE__ */ Symbol.for("tokens")] = e.tokens ?? [], t[/* @__PURE__ */ Symbol.for("printedComments")] = /* @__PURE__ */ new Set(), PF(
    e,
    t
  );
...
`) && (t = t.slice(0, -1))), mt.prototype.equals.call(this, e, t, r);
  ...
  a(wF, "Gr");
  a(ul, "me");
  je = /* @__PURE__ */ Symbol("MODE_BREAK"), kt = /* @__PURE__ */ Symbol("MODE_FLAT"), po = /* @__PURE__ */ Symbol("cursor"), $c = /* @__PURE__ */ Symbol("DOC_FILL_PRINTED_LENGTH");
  a(fg, "Kr");
  a(bF, "zu");
  a(yF, "Gu");
  a(Vc, "Pt");
...
in order for it to be formatted.`,
  ...
  }, "mn"), go = ml(Zc(), 1), Cg = /* @__PURE__ */ Symbol.for("vnopts.VALUE_NOT_EXIST"), pl = /* @__PURE__ */ Symbol.for("vnopts.VALUE_UNCHANGED"), _m = " ".repeat(2), tk = a((e, t, r) => {
  ...
  if (E) {
    if (i) {
      var V, ee = x === "y" ? oe : ie, I = x === "y" ? ge : ue, T = x === "y" ? "height" : "width", P = E[x], q = P + v[ee], $ = P - v[I], U = g ? -F[T] / 2 : 0, H = b === Xt ? R[T] : F[T], X = b === Xt ? -F[T] : -R[T], He = t.elements.arrow, Ee = g && He ? on(He) : {
        ...
        R[T],
        Ee[T]
      ), sa = D6 ? R[T] / 2 - U - Oe - ke - k.mainAxis : H - Oe - ke - k.mainAxis, ua = D6 ? -R[T] / 2 + U + Oe + ze + k.mainAxis : X + Oe + ze + k.mainAxis, fs = t.elements.arrow && yt(t.elements.arrow), A7 = fs ? x === "y" ? fs.clientTop || 0 : fs.clientLeft || 0 : 0, Dp = (V = B?.[x]) != null ? V : 0, F7 = P + sa - Dp - A7, k7 = P + ua - Dp, xp = ln(g ? nn(q, F7) : q, P, g ? bt($, k7) : $);
      E[x] = xp, j6[x] = xp - P;
    }
    if (s) {
      var Cp, L7 = x === "x" ? oe : ie, T7 = x === "x" ? ge : ue, Er = E[C], si = C === "y" ? "height" : "width", Ep = Er + v[L7], Rp = Er - v[T7], hs = [oe, ie].indexOf(y) !== -1, Sp = (Cp = B?.[C]) != null ? Cp : 0, Ap = hs ? Ep : Er - R[si] - F[si] - Sp + k.altAxis, Fp = hs ? Er + R[si] + F[si] - Sp - k.altAxis : Rp, kp = g && hs ? l3(Ap, Er, Fp) : ln(g ? Ap : Ep, Er, g ? Fp : Rp);
      E[C] = kp, j6[C] = kp - Er;
    }
...
function t4(e, t = []) {
  ...
  function n(i, l) {
    ...
    r = [...r, l];
    let p = a((h5) => {
      let { scope: f, children: g, ...w } = h5, m = f?.[e]?.[c] || s, v = ot.useMemo(() => w, Object.values(w));
...
var g0 = QL.reduce((e, t) => {
  let r = l4(`Primitive.${t}`), n = s4.forwardRef((o, i) => {
    ...
    return typeof window < "u" && (window[/* @__PURE__ */ Symbol.for("radix-ui")] = true), (0, import_jsx_runtime8.jsx)(c, { ...s, ref: i });
  });
...
var b0 = re.forwardRef(
  (e, t) => {
    let {
      ...
      onDismiss: s,
      ...c
    } = e, p = re.useContext(v4), [d, h5] = re.useState(null), f = d?.ownerDocument ?? globalThis?.document, [, g] = re.useState({}), w = m0(
      t,
      (R) => h5(R)
...
var sT = /* @__PURE__ */ Symbol("radix.slottable");
function uT(e) {
...
var R4 = hT.reduce((e, t) => {
  let r = C4(`Primitive.${t}`), n = E4.forwardRef((o, i) => {
    let { asChild: l, ...s } = o, c = l ? r : t;
    return typeof window < "u" && (window[/* @__PURE__ */ Symbol.for("radix-ui")] = true), (0, import_jsx_runtime11.jsx)(c, { ...s, ref: i });
  });
  return n.displayName = `Primitive.${t}`, { ...e, [t]: n };
}, {});
function D0(e) {
...
var P4 = TT.reduce((e, t) => {
  let r = M4(`Primitive.${t}`), n = _4.forwardRef((o, i) => {
    let { asChild: l, ...s } = o, c = l ? r : t;
    return typeof window < "u" && (window[/* @__PURE__ */ Symbol.for("radix-ui")] = true), (0, import_jsx_runtime14.jsx)(c, { ...s, ref: i });
  });
  return n.displayName = `Primitive.${t}`, { ...e, [t]: n };
}, {});
var MT = "Portal";
...
var No = UT.reduce((e, t) => {
  let r = Ll(`Primitive.${t}`), n = V4.forwardRef((o, i) => {
    let { asChild: l, ...s } = o, c = l ? r : t;
    return typeof window < "u" && (window[/* @__PURE__ */ Symbol.for("radix-ui")] = true), (0, import_jsx_runtime17.jsx)(c, { ...s, ref: i });
  });
  return n.displayName = `Primitive.${t}`, { ...e, [t]: n };
}, {});
var S0 = 0;
    ...
    return (0, import_jsx_runtime18.jsx)(
      vv,
      {
        ...
        onCloseAutoFocus: a((i) => {
          e.onCloseAutoFocus?.(i), i.defaultPrevented || (n.current || r.triggerRef.current?.focus(), i.preventDefault()), n.current = false, o.current = false;
        }, "onCloseAutoFocus"),
        onInteractOutside: a((i) => {
          e.onInteractOutside?.(i), i.defaultPrevented || (n.current = true, i.detail.originalEvent.type === "pointerdown" && (o.current = true));
          let l = i.target;
...
${t}`);
  ...
  return import_react25.default.createElement(import_react25.Fragment, null, import_react25.default.createElement("span", null, n), ": ", import_react25.default.createElement(
    ...
    (s, c) => s?.name ? import_react25.default.createElement(import_react25.Fragment, { key: c }, "  ", "at ", import_react25.default.createElement(EB, null, s.name), " (", import_react25.default.createElement(_v, null, s.location), ")", import_react25.default.createElement("br", null)) : import_react25.default.createElement(
      import_react25.Fragment,
      { key: c },
      "  ",
      "at ",
      import_react25.default.createElement(_v, null, s?.location),
...
function b7(e) {
  let t = (0, import_react40.useRef)(), r = (0, import_react40.useRef)(), n = (0, import_react40.useRef)(/* @__PURE__ */ new Map()), { width: o = 1 } = jl({
    ...
    let { x: f, width: g } = t.current.getBoundingClientRect(), { width: w } = r.current.getBoundingClientRect(), m = s.length ? f + g - w : f + g, v = [], y = 0, b = e.filter((D6) => {
      let { id: x } = D6, C = n.current.get(x), { width: E = 0 } = C?.getBoundingClientRect() || {}, R = f + y + E > m;
...
//# sourceMappingURL=chunk-6IEGYB3Y.js.map
