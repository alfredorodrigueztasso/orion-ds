...
// ../../node_modules/.pnpm/@storybook+react@8.6.15_react-dom@19.2.4_react@19.2.4__react@19.2.4_storybook@8.6.15_typescript@5.9.3/node_modules/@storybook/react/dist/chunk-EWIU6LHT.mjs
...
var renderJsx = (code, options) => {
  ...
  typeof options?.displayName == "string" ? displayNameDefaults = { showFunctions: true, displayName: () => options.displayName } : displayNameDefaults = { displayName: (el) => el.type.displayName ? el.type.displayName : Y(el.type, "displayName") ? Y(el.type, "displayName") : el.type.render?.displayName ? el.type.render.displayName : typeof el.type == "symbol" || el.type.$$typeof && typeof el.type.$$typeof == "symbol" ? getReactSymbolName(el.type) : el.type.name && el.type.name !== "_default" ? el.type.name : typeof el.type == "function" ? "No Display Name" : isForwardRef(el.type) ? el.type.render.name : isMemo(el.type) ? el.type.type.name : el.type };
...
var skipJsxRender = (context) => {
  ...
  return sourceParams?.type === gt.DYNAMIC ? false : !isArgsStory || sourceParams?.code || sourceParams?.type === gt.CODE;
};
...
var jsxDecorator = (storyFn, context) => {
  ...
  let options = { ...defaultOpts, ...context?.parameters.jsx || {} }, storyJsx = context?.parameters.docs?.source?.excludeDecorators ? context.originalStoryFn(context.args, context) : story, sourceJsx = mdxToJsx(storyJsx), rendered = renderJsx(sourceJsx, options);
...
//# sourceMappingURL=chunk-HQGURZXE.js.map
