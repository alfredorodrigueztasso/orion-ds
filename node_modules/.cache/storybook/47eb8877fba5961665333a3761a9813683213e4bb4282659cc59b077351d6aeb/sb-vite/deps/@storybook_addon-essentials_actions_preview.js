...
// ../../node_modules/.pnpm/@storybook+addon-actions@8.6.14_storybook@8.6.15/node_modules/@storybook/addon-actions/dist/preview.mjs
...
var serializeArg = (a) => {
  if (isReactSyntheticEvent(a)) {
    ...
    return typeof view == "object" && view?.constructor.name === "Window" && Object.defineProperty(e, "view", { ...viewDescriptor, value: Object.create(view.constructor.prototype) }), e;
  }
  return a;
};
...
function action(name, options = {}) {
  let actionOptions = { ...config, ...options }, handler = function(...args) {
    if (options.implicit) {
      let storyRenderer = ("__STORYBOOK_PREVIEW__" in import_global.global ? import_global.global.__STORYBOOK_PREVIEW__ : void 0)?.storyRenders.find((render) => render.phase === "playing" || render.phase === "rendering");
      if (storyRenderer) {
        let deprecated = !globalThis?.FEATURES?.disallowImplicitActionsInRenderV8, error = new import_preview_errors.ImplicitActionsDuringRendering({ phase: storyRenderer.phase, name, deprecated });
...
var logActionsWhenMockCalled = (context) => {
  ...
  if (!actions?.disable && !subscribed && "__STORYBOOK_TEST_ON_MOCK_CALL__" in import_global.global && typeof import_global.global.__STORYBOOK_TEST_ON_MOCK_CALL__ == "function") {
