...
// ../../node_modules/.pnpm/@storybook+addon-backgrounds@8.6.14_storybook@8.6.15/node_modules/@storybook/addon-backgrounds/dist/preview.mjs
...
var decorators = globalThis.FEATURES?.backgroundsStoryGlobals ? [withBackgroundAndGrid] : [withGrid, withBackground];
var parameters = { [PARAM_KEY]: { grid: { cellSize: 20, opacity: 0.5, cellAmount: 5 }, disable: false, ...!globalThis.FEATURES?.backgroundsStoryGlobals && { values: Object.values(DEFAULT_BACKGROUNDS) } } };
var modern = { [PARAM_KEY]: { value: void 0, grid: false } };
var initialGlobals = globalThis.FEATURES?.backgroundsStoryGlobals ? modern : { [PARAM_KEY]: null };
export {
  decorators,
  initialGlobals,
  parameters
