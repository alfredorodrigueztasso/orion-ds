  ...
  (
    ...
    const getIconAnimationClass = (position: 'left' | 'right') => {
      ...
      switch (iconAnimation) {
        case 'arrow': return styles.iconArrow;
        case 'arrow-left': return styles.iconArrowLeft;
        case 'external': return styles.iconExternal;
        default: return '';
      }
    };
    ...
    const renderRightIcon = () => {
      if (iconRight) {
        return (
          <span className={`${styles.icon} ${styles.iconRight} ${getIconAnimationClass('right')}`} aria-hidden="true">
            {iconRight}
          </span>
        );
      }
      ...
      if (external && showExternalIcon) {
        return (
          <span className={`${styles.icon} ${styles.iconRight} ${styles.iconExternal}`} aria-hidden="true">
