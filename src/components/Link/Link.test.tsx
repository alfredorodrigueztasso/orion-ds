...
describe('Link', () => {
  ...
  it('applies variant classes', () => {
    const { rerender } = render(<Link href="/" variant="subtle">Link</Link>);
    expect(screen.getByRole('link').className).toContain('subtle');

    rerender(<Link href="/" variant="brand">Link</Link>);
    expect(screen.getByRole('link').className).toContain('brand');
  });

  it('applies size classes', () => {
    const { rerender } = render(<Link href="/" size="sm">Link</Link>);
  ...
  it('removes underline when underline is false', () => {
    render(<Link href="/" underline={false}>Link</Link>);
