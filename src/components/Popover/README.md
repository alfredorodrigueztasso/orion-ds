  ...
  content={
    <div style={{ width: 250 }}>
      ...
      <div style={{ padding: '8px' }}>
        <Button variant="ghost" fullWidth>View Profile</Button>
        <Button variant="ghost" fullWidth>Settings</Button>
        <Button variant="ghost" fullWidth>Sign out</Button>
      </div>
    </div>
  }
/>
...
```tsx
<Popover
  trigger={<Button variant="ghost" icon={<MoreVertical size={20} />} iconOnly aria-label="More options" />}
