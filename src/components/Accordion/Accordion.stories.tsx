...
export const WithDisabledItems: Story = {
  args: {
    items: [
      { id: '1', title: 'Available Section', content: 'This section can be expanded.' },
      { id: '2', title: 'Disabled Section', content: 'This content is hidden.', disabled: true },
      { id: '3', title: 'Another Available', content: 'This section can also be expanded.' },
    ],
  },
};
