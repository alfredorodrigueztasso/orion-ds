...
describe('Select', () => {
  ...
  it('renders with required indicator', () => {
    const { container } = render(<Select label="Country" options={mockOptions} required id="country-select" />);
  ...
  it('links error message with select via aria-describedby', () => {
    render(
      <Select label="Country" options={mockOptions} error="Required" id="country-select" />
    );
    const select = screen.getByLabelText('Country');
