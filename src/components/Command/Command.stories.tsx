        ...
        <Command.Dialog open={open} onOpenChange={setOpen}>
          ...
          <Command.List>
            ...
            <Command.Group heading="Navigation">
              <Command.Item onSelect={() => { console.log('Home'); setOpen(false); }}>
                <FileText size={16} /> Home
              </Command.Item>
              <Command.Item onSelect={() => { console.log('Mail'); setOpen(false); }}>
                <Mail size={16} /> Mail
                <Command.Shortcut>⌘M</Command.Shortcut>
              </Command.Item>
              <Command.Item onSelect={() => { console.log('Calendar'); setOpen(false); }}>
                <Calendar size={16} /> Calendar
            ...
            <Command.Group heading="Theme">
              <Command.Item onSelect={() => { console.log('Light'); setOpen(false); }}>
                <Sun size={16} /> Light Mode
              </Command.Item>
              <Command.Item onSelect={() => { console.log('Dark'); setOpen(false); }}>
                <Moon size={16} /> Dark Mode
              </Command.Item>
            </Command.Group>
            <Command.Separator />
            <Command.Group heading="Account">
              <Command.Item onSelect={() => { console.log('Profile'); setOpen(false); }}>
                <User size={16} /> Profile
                <Command.Shortcut>⌘P</Command.Shortcut>
              </Command.Item>
              <Command.Item onSelect={() => { console.log('Logout'); setOpen(false); }}>
