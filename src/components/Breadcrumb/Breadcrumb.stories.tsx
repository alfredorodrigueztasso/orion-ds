...
import { Home, Settings, User, ChevronRight, LayoutDashboard, TrendingUp, DollarSign, ShieldCheck, Users } from 'lucide-react';
  ...
  decorators: [
    (Story) => (
      <div style={{ width: '600px' }}>
        <h4 style={{ marginBottom: 'var(--spacing-4)', fontSize: 'var(--font-size-14)', color: 'var(--text-secondary)' }}>
    ...
    (Story) => (
      ...
      >
        ...
        <div style={{ marginTop: 'var(--spacing-8)' }}>
          ...
          <p style={{ margin: 0, fontSize: 'var(--font-size-18)', color: 'var(--text-brand)', fontWeight: 'var(--font-weight-medium)' }}>$29.99</p>
        </div>
      </div>
    ),
  ],
  ...
  decorators: [
    (Story) => (
      ...
      >
        <Story />
        <div style={{ marginTop: 'var(--spacing-8)' }}>
          <h1 style={{ margin: '0 0 var(--spacing-4) 0', fontSize: 'var(--font-size-24)', fontWeight: 'var(--font-weight-bold)' }}>Breadcrumb</h1>
          <p style={{ margin: 0, fontSize: 'var(--font-size-16)', color: 'var(--text-secondary)', lineHeight: 1.6 }}>
  ...
  render: () => {
    ...
    return (
      ...
      >
        ...
        <div style={{ marginTop: 'var(--spacing-8)' }}>
          <h2 style={{ margin: '0 0 var(--spacing-6) 0', fontSize: 'var(--font-size-24)', fontWeight: 'var(--font-weight-medium)' }}>
            Revenue Report
          </h2>
...
export const AllSizes: Story = {
  args: { items: basicItems },
  render: () => (
    <div style={{ width: '600px', display: 'flex', flexDirection: 'column', gap: 'var(--spacing-8)' }}>
      <div>
...
export const AllSeparators: Story = {
  ...
  render: () => (
    <div style={{ width: '600px', display: 'flex', flexDirection: 'column', gap: 'var(--spacing-8)' }}>
      ...
      <div>
        <p style={{ marginBottom: 'var(--spacing-2)', fontSize: 'var(--font-size-14)', fontWeight: 'var(--font-weight-medium)' }}>Slash</p>
      ...
      <div>
        <p style={{ marginBottom: 'var(--spacing-2)', fontSize: 'var(--font-size-14)', fontWeight: 'var(--font-weight-medium)' }}>Custom (Dot)</p>
        <Breadcrumb
          items={basicItems}
          separator="custom"
          customSeparator={<span style={{ color: 'var(--text-tertiary)' }}>•</span>}
  ...
  render: () => {
    ...
    return (
      ...
      >
        ...
        <div style={{ marginTop: 'var(--spacing-8)' }}>
          <h2 style={{ margin: '0 0 var(--spacing-4) 0', fontSize: 'var(--font-size-24)', fontWeight: 'var(--font-weight-medium)' }}>
            John Doe (#12345)
          </h2>
