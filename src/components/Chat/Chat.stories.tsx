...
const StreamingAssistantMessage: React.FC<{ text: string; onComplete?: () => void }> = ({ text, onComplete }) => {
...
export const WithSidebar: Story = {
  render: function ChatWithSidebar() {
    ...
    return (
      <div style={{ display: 'flex', height: '600px', border: '1px solid var(--border-subtle)', borderRadius: 'var(--radius-container)', overflow: 'hidden' }}>
        <Chat.Sidebar
...
export const TypingIndicator: Story = {
  ...
  decorators: [
    (Story) => (
      <div style={{ background: 'var(--surface-subtle)', padding: 'var(--spacing-4)', borderRadius: 'var(--radius-container)' }}>
        <Story />
      </div>
    ),
  ],
...
export const DarkMode: Story = {
  ...
  decorators: [
    (Story) => (
      <div data-theme="dark" style={{ height: '500px', background: 'var(--surface-base)', borderRadius: 'var(--radius-container)' }}>
        <Story />
      </div>
    ),
  ],
