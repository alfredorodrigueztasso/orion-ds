...
const ICON_CATEGORIES: Record<string, string[]> = {
  'Navigation': [
    ...
    'ArrowDown', 'ArrowUp', 'ArrowLeft', 'ArrowRight', 'Home', 'Settings',
    'Bell', 'User', 'LogOut', 'LogIn', 'Search', 'MapPin', 'Navigation',
  ],
  'Actions': [
    'Plus', 'Minus', 'Check', 'Copy', 'Download', 'Upload', 'Share2',
    'Trash2', 'Edit', 'Eye', 'EyeOff', 'Lock', 'Unlock', 'Zap', 'Refresh',
    'RotateCw', 'Save', 'Send', 'Archive', 'Flag',
  ],
  'Status': [
    'AlertCircle', 'CheckCircle', 'XCircle', 'Info', 'HelpCircle',
    'AlertTriangle', 'CheckCircle2', 'Circle', 'Loader', 'Loader2',
    'Clock', 'Calendar',
  ],
  'Media': [
    'Image', 'Video', 'Music', 'FileText', 'File', 'Folder', 'FolderOpen',
    'Camera', 'Paperclip', 'Play', 'Pause', 'Volume2', 'VolumeX',
  ],
  'Communication': [
    'Mail', 'MessageSquare', 'Heart', 'Star', 'Share', 'MessageCircle',
    'Phone', 'Smartphone', 'Gift', 'ThumbsUp', 'ThumbsDown',
  ],
  'Commerce': [
    'ShoppingCart', 'DollarSign', 'CreditCard', 'Tag', 'Briefcase',
  ...
  return (
    <div className={`${styles.gallery}${className ? ` ${className}` : ''}`}>
      ...
      <div className={styles.searchContainer}>
        ...
        />
        {searchTerm && (
          <span className={styles.resultCount}>{filteredIcons.length} results</span>
        )}
      </div>
