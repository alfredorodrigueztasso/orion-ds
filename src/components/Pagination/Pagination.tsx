        ...
        <ul className={styles.list}>
            ...
            <li>
              ...
              >
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M11 12L7 8l4-4M5 12V4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
            </li>
          )}
          ...
          {showFirstLast && (
            <li>
              ...
              >
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <path d="M5 12l4-4-4-4M11 12V4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button>
            </li>
          )}
