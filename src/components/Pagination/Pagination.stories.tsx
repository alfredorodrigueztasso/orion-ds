...
export const AllSizes: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-6)', alignItems: 'center' }}>
      <div>
        <p style={{ marginBottom: 'var(--spacing-2)', fontWeight: 'var(--font-weight-medium)' }}>Small</p>
        <InteractivePagination size="sm" />
      </div>
      <div>
        <p style={{ marginBottom: 'var(--spacing-2)', fontWeight: 'var(--font-weight-medium)' }}>Medium (Default)</p>
        <InteractivePagination size="md" />
      </div>
      <div>
        <p style={{ marginBottom: 'var(--spacing-2)', fontWeight: 'var(--font-weight-medium)' }}>Large</p>
