  ...
  render: () => {
    ...
    return (
      <div>
        ...
        />
        <p style={{ marginTop: 'var(--spacing-4)', fontSize: 'var(--font-size-14)', color: 'var(--text-secondary)' }}>
...
export const SettingsPanel: Story = {
  render: () => {
    ...
    return (
      ...
      >
        <h3 style={{ marginBottom: 'var(--spacing-6)', fontSize: 'var(--font-size-16)', fontWeight: 'var(--font-weight-medium)' }}>
          Settings
        </h3>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-6)' }}>
          <Switch
            ...
            onChange={(e) =>
              setFeatures((prev) => ({ ...prev, experimental: e.target.checked }))
            }
          />
          <Switch
            label="Beta Features"
            ...
            onChange={(e) =>
              setFeatures((prev) => ({ ...prev, betaFeatures: e.target.checked }))
            }
          />
          <Switch
            label="Advanced Mode"
            ...
            onChange={(e) =>
              setFeatures((prev) => ({ ...prev, advancedMode: e.target.checked }))
            }
          />
        </div>
      </div>
...
export const InlineWithContent: Story = {
  render: () => (
    ...
    >
      <div>
        <div style={{ fontWeight: 'var(--font-weight-medium)', marginBottom: 'var(--spacing-1)' }}>Push Notifications</div>
