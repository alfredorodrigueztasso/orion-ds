...
export const AllSizes: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-8)' }}>
      <div>
        <p style={{ marginBottom: 'var(--spacing-2)', fontWeight: 'var(--font-weight-medium)', fontSize: 'var(--font-size-14)' }}>Small</p>
        <InteractiveSlider size="sm" showValue />
      </div>
      <div>
        <p style={{ marginBottom: 'var(--spacing-2)', fontWeight: 'var(--font-weight-medium)', fontSize: 'var(--font-size-14)' }}>Medium (Default)</p>
        <InteractiveSlider size="md" showValue />
      </div>
      <div>
        <p style={{ marginBottom: 'var(--spacing-2)', fontWeight: 'var(--font-weight-medium)', fontSize: 'var(--font-size-14)' }}>Large</p>
    ...
    return (
      <div>
        <div style={{ textAlign: 'center', marginBottom: 'var(--spacing-4)' }}>
          <span style={{ fontSize: 'var(--font-size-48)', fontWeight: 'var(--font-weight-bold)' }}>{temp}°</span>
