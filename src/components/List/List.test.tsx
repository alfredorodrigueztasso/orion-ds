...
describe('List', () => {
  ...
  it('renders leading content', () => {
    const items = [
      { id: '1', primary: 'Item 1', leading: <span data-testid="leading">Icon</span> },
    ];
  ...
  it('renders trailing content', () => {
    const items = [
      { id: '1', primary: 'Item 1', trailing: <span data-testid="trailing">Badge</span> },
    ];
    render(<List items={items} />);
  ...
  it('does not trigger click on disabled items', () => {
    const onClick = vi.fn();
    const items = [
      { id: '1', primary: 'Item 1', onClick, disabled: true },
    ];
    render(<List items={items} interactive />);
  ...
  it('renders different sizes', () => {
    const { container, rerender } = render(<List items={mockItems} size="sm" />);
  ...
  it('renders different variants', () => {
    const { container, rerender } = render(<List items={mockItems} variant="bordered" />);
