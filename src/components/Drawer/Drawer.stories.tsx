        ...
        >
          ...
          <Drawer.Body>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-6)' }}>
              <div>
                <h4 style={{ marginBottom: 'var(--spacing-2)', fontWeight: 'var(--font-weight-medium)' }}>Appearance</h4>
                <p style={{ fontSize: 'var(--font-size-14)', color: 'var(--text-secondary)' }}>
                  Customize how the app looks on your device.
                </p>
              </div>
              <div>
                <h4 style={{ marginBottom: 'var(--spacing-2)', fontWeight: 'var(--font-weight-medium)' }}>Notifications</h4>
                <p style={{ fontSize: 'var(--font-size-14)', color: 'var(--text-secondary)' }}>
                  Configure when and how you receive notifications.
                </p>
              </div>
              <div>
                <h4 style={{ marginBottom: 'var(--spacing-2)', fontWeight: 'var(--font-weight-medium)' }}>Privacy</h4>
                <p style={{ fontSize: 'var(--font-size-14)', color: 'var(--text-secondary)' }}>
