...
const sampleUsers: UserData[] = [
  ...
  { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'Editor', status: 'active', lastActive: '5 min ago' },
  { id: 3, name: 'Bob Wilson', email: 'bob@example.com', role: 'Viewer', status: 'inactive', lastActive: '3 days ago' },
  { id: 4, name: 'Alice Brown', email: 'alice@example.com', role: 'Editor', status: 'pending', lastActive: '1 hour ago' },
  { id: 5, name: 'Charlie Davis', email: 'charlie@example.com', role: 'Admin', status: 'active', lastActive: '10 min ago' },
  { id: 6, name: 'Eva Martinez', email: 'eva@example.com', role: 'Viewer', status: 'active', lastActive: '1 day ago' },
  { id: 7, name: 'Frank Lee', email: 'frank@example.com', role: 'Editor', status: 'inactive', lastActive: '1 week ago' },
  { id: 8, name: 'Grace Kim', email: 'grace@example.com', role: 'Viewer', status: 'active', lastActive: '3 hours ago' },
];
...
const columns = [
  ...
  { key: 'role', header: 'Role', sortable: true },
  {
    ...
    render: (value: unknown) => {
      ...
      const variant: BadgeVariant = status === 'active' ? 'success' : status === 'pending' ? 'warning' : 'neutral';
