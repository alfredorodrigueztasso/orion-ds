...
<UserMenu
  ...
  sections={[
    ...
    },
    {
      id: 'actions',
      items: [
        { id: 'logout', label: 'Sign out', icon: <LogOut size={16} />, onClick: handleLogout, danger: true }
      ]
    }
  ]}
/>
...
<UserMenu
  ...
  sections={[
    ...
    },
    {
      ...
      label: 'Admin',
      items: [
        { id: 'dashboard', label: 'Admin Dashboard', icon: <LayoutDashboard size={16} />, href: '/admin' },
...
// Avoid: Vague labels
{ label: "Settings" }  // Settings for what?
```
