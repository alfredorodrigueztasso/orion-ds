...
const defaultTestimonials = [
  {
    quote: 'Orion has completely transformed how we build products. The component library is incredibly well thought out and saves us countless hours.',
    author: {
      name: 'Sarah Chen',
  ...
  {
    quote: 'The best design system I have ever used. The documentation is excellent and the components just work perfectly together.',
    author: {
  ...
  {
    quote: 'We migrated our entire platform to Orion in just two weeks. The TypeScript support is fantastic.',
    author: {
      name: 'Emily Davis',
      role: 'CTO',
      company: 'StartupXYZ',
