  ...
  args: {
    ...
    children: (
      <nav style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-2)' }}>
        <a href="#" style={{ padding: 'var(--spacing-3)', background: 'var(--surface-subtle)', borderRadius: 'var(--radius-sm)', textDecoration: 'none', color: 'inherit' }}>Dashboard</a>
        <a href="#" style={{ padding: 'var(--spacing-3)', background: 'var(--surface-subtle)', borderRadius: 'var(--radius-sm)', textDecoration: 'none', color: 'inherit' }}>Projects</a>
        <a href="#" style={{ padding: 'var(--spacing-3)', background: 'var(--surface-subtle)', borderRadius: 'var(--radius-sm)', textDecoration: 'none', color: 'inherit' }}>Team</a>
        <a href="#" style={{ padding: 'var(--spacing-3)', background: 'var(--surface-subtle)', borderRadius: 'var(--radius-sm)', textDecoration: 'none', color: 'inherit' }}>Settings</a>
      </nav>
    ),
  },
};
