  ...
  args: {
    ...
    footer: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-2)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-3)', padding: 'var(--spacing-2)' }}>
          <div
            style={{
              width: '36px',
              height: '36px',
          ...
          />
          <div>
            <div style={{ fontWeight: 'var(--font-weight-medium)', fontSize: 'var(--font-size-14)' }}>John Doe</div>
            <div style={{ fontSize: 'var(--font-size-12)', color: 'var(--text-secondary)' }}>Admin</div>
          </div>
        </div>
    ...
    header: (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-3)', width: '100%' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ fontWeight: 'var(--font-weight-medium)', fontSize: 'var(--font-size-18)' }}>Workspace</span>
...
export const Floating: Story = {
  ...
  decorators: [
    (Story) => (
      <div style={{ height: '600px', display: 'flex', padding: '0', background: 'var(--surface-subtle)' }}>
        <Story />
...
export const WithLogo: Story = {
  args: {
    header: (
      <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-2)' }}>
        <Box size={24} />
        <span style={{ fontWeight: 'var(--font-weight-medium)', fontSize: 'var(--font-size-16)' }}>Acme Inc</span>
      </div>
    ),
    sections: defaultSections,
    activeItem: 'dashboard',
