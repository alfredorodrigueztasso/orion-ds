...
export const SocialProof: React.FC<SocialProofProps> = ({
  ...
  const showTestimonials = testimonials.length > 0 && layout !== 'logos-only' && layout !== 'stats-only';
    ...
    <div className={styles.logosSection}>
      <div className={logoStyle === 'inline' ? styles.logosInline : styles.logosGrid}>
        {logos.map((logo, index) => {
          ...
          const logoProps = logo.href ? { href: logo.href, target: '_blank', rel: 'noopener noreferrer' } : {};
