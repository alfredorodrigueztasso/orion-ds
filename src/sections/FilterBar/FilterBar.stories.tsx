...
const InteractiveFilterBar = (args: Partial<React.ComponentProps<typeof FilterBar>>) => {
  const [activeFilters, setActiveFilters] = useState<ActiveFilter[]>([]);
  const [search, setSearch] = useState('');

  const handleFilterChange = (key: string, value: string | string[] | { start: string; end: string } | null) => {
    if (value === null) {
