...
const AppleStoreBadge: React.FC = () => (
  <svg width="135" height="40" viewBox="0 0 135 40">
    ...
    <text x="67.5" y="12" fill="#fff" fontSize="8" textAnchor="middle" fontFamily="system-ui">Download on the</text>
    <text x="67.5" y="28" fill="#fff" fontSize="16" textAnchor="middle" fontWeight="600" fontFamily="system-ui">App Store</text>
  </svg>
);
...
const GooglePlayBadge: React.FC = () => (
  <svg width="135" height="40" viewBox="0 0 135 40">
    <rect width="135" height="40" rx="5" fill="#000" />
    <text x="67.5" y="12" fill="#fff" fontSize="8" textAnchor="middle" fontFamily="system-ui">GET IT ON</text>
    <text x="67.5" y="28" fill="#fff" fontSize="14" textAnchor="middle" fontWeight="600" fontFamily="system-ui">Google Play</text>
  </svg>
);
...
const StarIcon: React.FC = () => (
  <svg className={styles.star} width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
