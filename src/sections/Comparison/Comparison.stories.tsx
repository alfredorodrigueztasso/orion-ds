...
export const WithCategories: Story = {
  args: {
    ...
    features: [
      { name: 'Users', values: ['1', '10', 'Unlimited'], category: 'Core Features' },
      { name: 'Storage', values: ['10GB', '100GB', '1TB'], category: 'Core Features' },
      { name: 'Email Support', values: [true, true, true], category: 'Support' },
      { name: 'Phone Support', values: [false, true, true], category: 'Support' },
      { name: 'Dedicated Manager', values: [false, false, true], category: 'Support' },
      { name: 'API Access', values: [false, true, true], category: 'Developer' },
...
export const WithCTA: Story = {
  args: {
    ...
    columns: [
      { title: 'Starter', subtitle: 'Free forever', ctaLabel: 'Get Started', ctaHref: '#' },
      { title: 'Pro', subtitle: '$29/month', highlighted: true, badge: 'Most Popular', ctaLabel: 'Start Trial', ctaHref: '#' },
      { title: 'Enterprise', subtitle: 'Custom pricing', ctaLabel: 'Contact Sales', ctaHref: '#' },
    ],
    features: [
      { name: 'Projects', values: ['3', 'Unlimited', 'Unlimited'] },
