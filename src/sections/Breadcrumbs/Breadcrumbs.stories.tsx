...
export const AllSizes: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-6)' }}>
      <div>
        <p style={{ marginBottom: 'var(--spacing-2)', fontSize: 'var(--font-size-12)', color: 'var(--text-tertiary)' }}>
          Small
        </p>
...
export const InPageContext: Story = {
  render: () => (
    <div style={{ padding: 'var(--spacing-4)', background: 'var(--surface-subtle)', borderRadius: 'var(--radius-sm)' }}>
      <Breadcrumbs
        items={[
        ...
        size="sm"
      />
      <h1 style={{ margin: 'var(--spacing-4) 0 var(--spacing-2)', fontSize: 'var(--font-size-24)', fontWeight: 'var(--font-weight-medium)' }}>
        Security Settings
      </h1>
