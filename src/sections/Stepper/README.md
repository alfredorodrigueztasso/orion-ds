...
<Stepper
  orientation="vertical"
  steps={[
    { id: 'profile', label: 'Your Profile', icon: <User size={20} />, description: 'Basic information' },
    { id: 'company', label: 'Company Details', icon: <Building size={20} />, description: 'Organization info' },
    { id: 'team', label: 'Invite Team', icon: <Users size={20} />, description: 'Add team members', optional: true },
