  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-8)' }}>
        ...
        <div style={{ textAlign: 'center', padding: 'var(--spacing-8)', background: 'var(--surface-subtle)', borderRadius: 'var(--radius-sm)' }}>
...
export const ConnectorStyles: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-12)' }}>
      <div>
        <p style={{ marginBottom: 'var(--spacing-4)', fontSize: 'var(--font-size-12)', color: 'var(--text-tertiary)' }}>
          Solid (default)
        </p>
