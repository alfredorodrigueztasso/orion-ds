...
<Gallery
  ...
  images={[
    { id: 1, src: "/gallery/project-1.jpg", alt: "E-commerce redesign", caption: "E-commerce Platform" },
    { id: 2, src: "/gallery/project-2.jpg", alt: "Mobile app design", caption: "Fitness App" },
    { id: 3, src: "/gallery/project-3.jpg", alt: "Dashboard interface", caption: "Analytics Dashboard" },
...
<Gallery
  showCaptions
  images={[
    { id: 1, src: "/img.jpg", alt: "...", caption: "Project Name" }
  ]}
/>
```
