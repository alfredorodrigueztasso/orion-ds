...
export const Filterable: Story = {
  args: {
    ...
    images: [
      ...
      { id: '2', src: 'https://picsum.photos/seed/2/600/400', alt: 'Architecture 1', category: 'Architecture' },
      { id: '3', src: 'https://picsum.photos/seed/3/600/400', alt: 'Nature 2', category: 'Nature' },
      { id: '4', src: 'https://picsum.photos/seed/4/600/400', alt: 'Portrait 1', category: 'Portrait' },
      { id: '5', src: 'https://picsum.photos/seed/5/600/400', alt: 'Architecture 2', category: 'Architecture' },
      { id: '6', src: 'https://picsum.photos/seed/6/600/400', alt: 'Portrait 2', category: 'Portrait' },
    ],
    filterable: true,
  },
};
