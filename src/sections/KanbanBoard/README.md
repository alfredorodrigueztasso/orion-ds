  ...
  columns={[
    {
      ...
      title: 'To Do',
      cards: [
        { id: '1', title: 'Design homepage', labels: [{ id: 'l1', text: 'Design', color: 'blue' }] },
    ...
    },
    {
      ...
      title: 'In Progress',
      cards: [
        { id: '3', title: 'Implement auth', assignees: [{ id: 'u1', name: 'John', avatar: '/john.jpg' }] }
      ]
    },
    {
      id: 'done',
      title: 'Done',
      cards: [
        { id: '4', title: 'Project setup', priority: 'high' }
      ]
    }
  ]}
  ...
  const [columns, setColumns] = useState([
    {
      ...
      color: 'default',
      cards: [
        { id: '1', title: 'User research', labels: [{ id: 'l1', text: 'Research', color: 'blue' }] },
        { id: '2', title: 'Competitive analysis', labels: [{ id: 'l1', text: 'Research', color: 'blue' }] }
      ]
    },
    {
      id: 'todo',
