...
const sampleNavigation = [
  {
    ...
    items: [
      ...
      { id: 'notifications', label: 'Notifications', icon: <Bell size={18} />, badge: <Badge variant="info">3</Badge> },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'api', label: 'API Keys', icon: <Key size={18} />, badge: <Badge>Pro</Badge> },
      { id: 'permissions', label: 'Permissions', icon: <Shield size={18} />, disabled: true },
    ],
  },
];
...
export const WideNavigation: Story = {
  render: () => {
    ...
    const navWithDescriptions = [
      {
        items: [
          { id: 'profile', label: 'Profile', icon: <User size={18} />, description: 'Manage your public profile' },
          { id: 'security', label: 'Security', icon: <Lock size={18} />, description: 'Password and 2FA settings' },
          { id: 'billing', label: 'Billing', icon: <CreditCard size={18} />, description: 'Payment methods and invoices' },
        ],
      },
    ];
    return (
