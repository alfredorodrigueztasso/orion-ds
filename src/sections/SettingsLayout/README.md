  ...
  const navigation = [
    {
      title: 'Account',
      items: [
        { id: 'profile', label: 'Profile', icon: <User size={18} />, description: 'Your personal information' },
        { id: 'appearance', label: 'Appearance', icon: <Palette size={18} />, description: 'Theme and display' },
        { id: 'notifications', label: 'Notifications', icon: <Bell size={18} />, badge: <Badge>5</Badge> }
      ]
    },
    {
      title: 'Security',
      items: [
        ...
        { id: 'two-factor', label: 'Two-Factor Auth', icon: <Shield size={18} />, badge: <Badge variant="warning">Setup</Badge> }
      ]
    },
    {
      title: 'Billing',
