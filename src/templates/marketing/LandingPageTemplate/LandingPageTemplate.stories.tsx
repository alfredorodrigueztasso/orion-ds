...
const TESTIMONIALS = [
  {
    quote: 'This platform transformed how we build products. We shipped our MVP in half the time.',
    author: {
      name: 'Sarah Chen',
      role: 'CTO',
      company: 'TechCorp',
  ...
  {
    quote: 'The developer experience is unmatched. Our team productivity increased by 40%.',
    author: {
      name: 'Mike Johnson',
      role: 'Lead Engineer',
      company: 'StartupXYZ',
  ...
  {
    quote: 'Finally, a design system that actually works. No more UI inconsistencies.',
    author: {
...
const FAQ_ITEMS = [
  {
    ...
    answer: "Sign up for a free account and follow our quick start guide. You'll be up and running in less than 5 minutes.",
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes! Our Starter plan is completely free and includes 5 projects and 10GB storage.',
  },
  {
    question: 'What kind of support do you offer?',
    answer: 'Starter plans get community support. Pro plans include priority email support. Enterprise gets dedicated support.',
  },
];
...
const FEATURES_CAROUSEL_ITEMS = [
  {
    image: <img src="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&h=600&fit=crop" alt="" />,
    eyebrow: 'Performance',
    title: 'Lightning Fast',
    description: 'Optimized for performance at every level. Sub-second load times guaranteed.',
    overlay: 'gradient' as const,
  ...
  {
    image: <img src="https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=800&h=600&fit=crop" alt="" />,
    eyebrow: 'Security',
    title: 'Secure by Default',
    description: 'Enterprise-grade security with SOC2 compliance and end-to-end encryption.',
    overlay: 'gradient' as const,
  ...
  {
    image: <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&h=600&fit=crop" alt="" />,
  ...
  {
    image: <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop" alt="" />,
    eyebrow: 'Insights',
    title: 'Analytics Built-in',
    description: 'Real-time insights and reporting without the complexity.',
    overlay: 'gradient' as const,
  ...
  {
    image: <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&h=600&fit=crop" alt="" />,
    eyebrow: 'Teamwork',
    title: 'Team Collaboration',
    description: 'Work together seamlessly with real-time collaboration features.',
    overlay: 'gradient' as const,
  ...
  {
    image: <img src="https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800&h=600&fit=crop" alt="" />,
    eyebrow: 'Global',
    title: 'Global CDN',
    description: 'Content delivered from edge locations worldwide for best performance.',
    overlay: 'gradient' as const,
  ...
  args: {
    navbar: {
      ...
      children: (
        <>
          <Navbar.Brand href="/">
            <span style={{ fontWeight: 'var(--font-weight-bold)', fontSize: 'var(--text-xl)' }}>Acme</span>
          </Navbar.Brand>
          <Navbar.Nav>
