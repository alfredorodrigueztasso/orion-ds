  ...
  return (
    <AboutPageTemplate
      ...
      hero={{
        ...
        description: 'Founded in 2019, we set out to make development accessible to everyone. Today, we help thousands of teams ship better products faster.',
        align: 'center',
        size: 'lg',
      }}
      storyCarousel={{
        ...
        items: [
          ...
          },
          {
            ...
            eyebrow: '2020',
            title: 'Public Launch',
            description: 'Launched our platform to the public, reaching 1,000 users in the first month.',
            overlay: 'gradient',
          },
          {
      ...
      team={{
        eyebrow: 'Our Team',
        title: 'Meet the people behind Acme',
        description: "We're a diverse team of engineers, designers, and business minds united by a shared mission.",
        members: [
          {
            name: 'Sarah Chen',
            role: 'CEO & Co-founder',
            ...
            socialLinks: [
              { label: 'Twitter', href: 'https://twitter.com/sarahchen', icon: <Twitter size={16} /> },
              { label: 'LinkedIn', href: 'https://linkedin.com/in/sarahchen', icon: <Linkedin size={16} /> },
            ],
          },
          {
            name: 'Mike Johnson',
          ...
          },
          {
            ...
            socialLinks: [
              { label: 'LinkedIn', href: 'https://linkedin.com/in/emilyr', icon: <Linkedin size={16} /> },
            ],
          },
          {
            name: 'David Kim',
            ...
            socialLinks: [
              { label: 'LinkedIn', href: 'https://linkedin.com/in/davidk', icon: <Linkedin size={16} /> },
            ],
          },
        ],
      }}
      cta={{
        ...
        actions: (
          <>
            ...
            <Button variant="ghost" size="lg">Learn About Our Culture</Button>
          </>
        ),
      }}
      footer={{
