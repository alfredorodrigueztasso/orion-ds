...
const SecuritySection = () => (
  <>
    ...
    >
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: 'var(--spacing-3)', backgroundColor: 'var(--surface-subtle)', borderRadius: 'var(--radius-sm)' }}>
        <div>
...
const BillingSection = () => (
  <>
    ...
    >
      <div style={{ padding: 'var(--spacing-4)', backgroundColor: 'var(--surface-subtle)', borderRadius: 'var(--radius-sm)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
      ...
      <div style={{ padding: 'var(--spacing-4)', backgroundColor: 'var(--surface-subtle)', borderRadius: 'var(--radius-sm)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-3)' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: 'var(--text-sm)' }}>Expires 12/2025</p>
          </div>
        </div>
