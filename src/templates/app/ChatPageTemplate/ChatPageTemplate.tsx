...
import type { ChatPageTemplateProps, ChatMessage as ChatMessageType } from '../../../components/Chat';
              ...
              <div style={{ position: 'relative' }}>
                ...
                {showUserMenu && (
                  <div className={styles.pageTemplateUserMenu} role="menu">
                    ...
                    {onLogout && (
                      <button
                        className={[styles.pageTemplateMenuItem, styles.pageTemplateMenuItemDanger].join(' ')}
                        onClick={() => {
                          setShowUserMenu(false);
                          onLogout();
                        }}
