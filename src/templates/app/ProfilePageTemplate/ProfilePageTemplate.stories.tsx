...
const USER_PROFILE = {
  ...
  actions: (
    <>
      <Button variant="ghost" icon={<MessageSquare size={18} />}>Message</Button>
      <Button variant="primary" icon={<Edit size={18} />}>Edit Profile</Button>
    </>
  ),
};
    ...
    <Card>
      ...
      <Card.Body>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.6 }}>
          ...
          Currently focused on building the next generation of developer tools at Acme.
        </p>
        <div style={{ marginTop: 'var(--spacing-4)', display: 'flex', gap: 'var(--spacing-2)', flexWrap: 'wrap' }}>
    ...
    <Card>
      ...
      <Card.Body>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 'var(--spacing-4)' }}>
          <div>
            <p style={{ color: 'var(--text-tertiary)', fontSize: 'var(--text-sm)', marginBottom: 'var(--spacing-1)' }}>Email</p>
            <p style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-2)' }}>
              <Mail size={16} /> sarah@acme.com
            </p>
          </div>
          <div>
            <p style={{ color: 'var(--text-tertiary)', fontSize: 'var(--text-sm)', marginBottom: 'var(--spacing-1)' }}>Phone</p>
            <p style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-2)' }}>
              <Phone size={16} /> +1 (555) 123-4567
            </p>
          </div>
          <div>
            <p style={{ color: 'var(--text-tertiary)', fontSize: 'var(--text-sm)', marginBottom: 'var(--spacing-1)' }}>Location</p>
            <p style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-2)' }}>
              <MapPin size={16} /> San Francisco, CA
            </p>
          </div>
          <div>
            <p style={{ color: 'var(--text-tertiary)', fontSize: 'var(--text-sm)', marginBottom: 'var(--spacing-1)' }}>Website</p>
            <p style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-2)' }}>
    ...
    <Card>
      ...
      <Card.Body>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-4)' }}>
          <div style={{ padding: 'var(--spacing-3)', backgroundColor: 'var(--surface-subtle)', borderRadius: 'var(--radius-sm)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <h4 style={{ margin: 0 }}>Mobile App v2</h4>
              <Badge variant="success">Active</Badge>
            </div>
            <p style={{ color: 'var(--text-secondary)', fontSize: 'var(--text-sm)', margin: 'var(--spacing-2) 0 0 0' }}>
