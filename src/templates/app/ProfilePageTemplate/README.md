...
<ProfilePageTemplate
  ...
  profile={{
    ...
    actions: (
      <Button variant="secondary" icon={<Edit size={18} />}>Edit Profile</Button>
    ),
  }}
  activityFeed={{
    activities: [
...
import {
  Home, Users, Settings, Mail, MapPin, Calendar, Building,
  Edit, MessageSquare, MoreHorizontal,
} from 'lucide-react';
      ...
      profile={{
        ...
        actions: (
          <>
            ...
            <Button variant="secondary" icon={<Edit size={18} />} onClick={() => setShowEditPanel(true)}>
              Edit Profile
            </Button>
            <Button variant="ghost" iconOnly icon={<MoreHorizontal size={18} />} aria-label="More options" />
          </>
        ),
      }}
      activityFeed={{
    ...
    >
      ...
      <section>
        ...
        <p>
          ...
          scalable web applications. Passionate about developer experience
          and design systems.
        </p>
      </section>
...
```tsx
<ProfilePageTemplate
  profile={{ name: 'John Doe', role: 'Engineer' }}
>
