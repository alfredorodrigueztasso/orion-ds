...
const SIDEBAR_SECTIONS = [
  {
    items: [
      ...
      { id: 'customers', label: 'Customers', icon: <Users size={20} />, href: '/customers', badge: <Badge size="sm">12</Badge> },
  ...
  { key: 'id', header: 'Order', width: '90px', sortable: true },
  {
    ...
    render: (_value: unknown, row: Record<string, unknown>) => (
      <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-3)' }}>
        <Avatar
          initials={String(row.customer).split(' ').map((n: string) => n[0]).join('')}
          size="sm"
        />
        <div>
          <div style={{ fontWeight: 'var(--font-weight-medium)' }}>{String(row.customer)}</div>
...
const TABLE_DATA = [
  { id: '#3210', customer: 'Olivia Martin', email: 'olivia@email.com', status: 'completed', amount: '$316.00', date: 'Jan 15, 2024' },
  { id: '#3209', customer: 'Jackson Lee', email: 'jackson@email.com', status: 'pending', amount: '$242.00', date: 'Jan 15, 2024' },
  { id: '#3208', customer: 'Isabella Nguyen', email: 'isabella@email.com', status: 'completed', amount: '$837.00', date: 'Jan 14, 2024' },
  { id: '#3207', customer: 'William Kim', email: 'william@email.com', status: 'processing', amount: '$129.00', date: 'Jan 14, 2024' },
  { id: '#3206', customer: 'Sofia Davis', email: 'sofia@email.com', status: 'completed', amount: '$459.00', date: 'Jan 13, 2024' },
  { id: '#3205', customer: 'Ethan Johnson', email: 'ethan@email.com', status: 'pending', amount: '$732.00', date: 'Jan 13, 2024' },
  { id: '#3204', customer: 'Emma Wilson', email: 'emma@email.com', status: 'completed', amount: '$284.00', date: 'Jan 12, 2024' },
  { id: '#3203', customer: 'Liam Brown', email: 'liam@email.com', status: 'completed', amount: '$596.00', date: 'Jan 12, 2024' },
];
...
const ACTIVITY_ITEMS = [
  {
    ...
    actor: { name: 'Olivia Martin', avatar: 'https://i.pravatar.cc/40?u=olivia' },
  },
  {
    id: '2',
    title: 'Jackson Lee updated their profile',
    timestamp: '15 minutes ago',
    actor: { name: 'Jackson Lee', avatar: 'https://i.pravatar.cc/40?u=jackson' },
  },
  {
    id: '3',
    title: 'Isabella Nguyen left a review',
    timestamp: '1 hour ago',
    actor: { name: 'Isabella Nguyen', avatar: 'https://i.pravatar.cc/40?u=isabella' },
  },
  {
    id: '4',
    title: 'William Kim requested a refund',
    timestamp: '2 hours ago',
    actor: { name: 'William Kim', avatar: 'https://i.pravatar.cc/40?u=william' },
  },
  {
    id: '5',
...
export const Default: Story = {
  args: {
    sidebar: {
      ...
      header: (
        <div style={{ padding: 'var(--spacing-4)', fontWeight: 'var(--font-weight-bold)', fontSize: 'var(--text-xl)' }}>
          Acme
        </div>
      ),
    },
    ...
    dataTable: {
      ...
      toolbar: (
        <h3 style={{ margin: 0, fontSize: 'var(--font-size-16)', fontWeight: 'var(--font-weight-medium)', color: 'var(--text-primary)' }}>
          Recent Orders
        </h3>
      ),
      pagination: {
...
export const WithoutSidebar: Story = {
  args: {
    pageHeader: {
      ...
      actions: (
        <Button variant="ghost" icon={<Download size={18} />}>Export Report</Button>
      ),
    },
    metrics: {
      metrics: METRICS,
...
export const Compact: Story = {
  args: {
    ...
    dataTable: {
      ...
      compact: true,
      toolbar: (
        <h3 style={{ margin: 0, fontSize: 'var(--font-size-14)', fontWeight: 'var(--font-weight-medium)', color: 'var(--text-primary)' }}>
          Recent Orders
        </h3>
      ),
    },
